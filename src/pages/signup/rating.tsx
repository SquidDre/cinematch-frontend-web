    ...
    <div className="flex flex-col min-h-screen font-sans text-white selection:bg-[#E85D22] selection:text-white">
      <div className="flex flex-col lg:flex-row flex-grow">
        ...
        <div className="w-full lg:w-1/2 bg-[#141414] p-8 md:p-16 flex flex-col justify-between lg:border-r lg:border-[#333] min-h-[50vh] lg:min-h-0">
          ...
          {/* Header (Left Side) */}
          <div className="flex justify-between w-full mb-12 lg:mb-12">
            <div className="text-xl font-bold tracking-[0.2em] text-black ml-4 text-gray-500">
              CINEMATCH
            </div>
          ...
          <div className="flex-grow flex flex-col justify-center">
            ...
            <h1 className="text-6xl md:text-8xl lg:text-[80px] font-serif tracking-tight leading-[0.9] text-white mb-6">
              Tell us your <br />
              <span className="italic text-[#E85D22]">taste.</span>
            </h1>
