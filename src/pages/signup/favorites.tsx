    ...
    <div className="flex flex-col min-h-screen font-sans">
      ...
      {/* Header */}
        <div className="w-full lg:w-1/2 bg-[#F4F1EA] p-8 md:p-16 md:pb-8 flex flex-col relative min-h-[50vh] lg:min-h-0">
          ...
          <div className="ml-4">
            <h1 className="text-6xl md:text-8xl lg:text-[110px] font-serif tracking-tight leading-none text-black">
              Pick your<span className="text-black"></span>
            </h1>
            
            <h1 className="text-6xl md:text-8xl lg:text-[110px] font-serif italic text-[#E85D22] tracking-tight leading-none mb-4">
              favorites.
            </h1>
