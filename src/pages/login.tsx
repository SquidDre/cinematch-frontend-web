      ...
      <div className="flex flex-col lg:flex-row flex-grow">
        ...
        <div className="w-full lg:w-1/2 bg-[#F4F1EA] p-8 md:p-16 md:pb-24 flex flex-col relative min-h-[50vh] lg:min-h-0">
          ...
          <div className="mb-8 lg:mb-8">
            <h1 className="text-7xl md:text-8xl lg:text-[110px] font-serif tracking-tight leading-[0.9] text-black mb-4">
              Welcome
            </h1>
          ...
          <p className="text-gray-500 text-lg md:text-xl max-w-md leading-relaxed mb-8 lg:mb-36">
            Start exlporing new movies.
          </p>
          
          <p className ="text-gray-500 text-lg md:text-xl mb-4 mt-auto lg:mx-0 text-center lg:text-center">

            {/* Link to Sign In page NOT FINISHED JUST TESTING */}
            Don't have an account? <a href="/create" className="text-[#E85D22] font-bold hover:underline">Sign up</a>
          </p>
        </div>
        ...
        <div className="w-full lg:w-1/2 bg-black p-8 md:p-16 flex flex-col min-h-[50vh] lg:min-h-0 md:pt-36">
          <div className="max-w-xl mx-auto w-full lg:mx-0 lg:ml-12">
            ...
            <h2 className="text-5xl md:text-6xl font-serif italic tracking-tight text-white mb-12 leading-tight">
              see you again.
            </h2>
